...
Frontend application for **PrimeTrade**, providing role-based dashboards for Admin and User with secure authentication and task/work management.
...
- Designed to work seamlessly with PrimeTrade Backend
